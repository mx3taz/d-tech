...
const rawProducts = [
  ...
  { brand: "TCL", category: "REF", reference: "P333 TMS", designation: "REF TCL Double portes 333L No Frost Inox", priceHT: 1750.000, characteristics: "Double portes, Capacité nette: 333L, Réfrigérateur: 256L, Congélateur: 77L, Classe A+, Total No Frost, LED, Inox, 600x1700x665mm" },
  { brand: "TCL", category: "REF", reference: "P425 TMN", designation: "REF TCL Double portes 420L No Frost Inverter Inox", priceHT: 2225.000, characteristics: "Double portes, Capacité nette: 420L, Réfrigérateur: 319L, Congélateur: 101L, Total No Frost, Inverter, LED, Twist Ice Maker, 706x1720x686mm, Garantie compresseur 10 ans" },
  { brand: "TCL", category: "REF", reference: "P465 TMN", designation: "REF TCL Double portes 465L No Frost Inverter Inox", priceHT: 2300.000, characteristics: "Double portes, Capacité nette: 465L, Réfrigérateur: 364L, Congélateur: 101L, Total No Frost, Inverter, Affichage LED externe, Inox, Twist Ice Maker, 706x1850x686mm, Garantie compresseur 10 ans" },
  { brand: "TCL", category: "REF", reference: "P545 TMN", designation: "REF TCL Double portes 540L No Frost Inverter Distributeur Inox", priceHT: 2680.000, characteristics: "Double portes, Capacité nette: 540L, Réfrigérateur: 398L, Congélateur: 142L, Distributeur d'eau, Total No Frost, Inverter, Affichage LED externe, Twist Ice Maker, Inox, 836x1850x688mm, Garantie compresseur 10 ans" },
  { brand: "TCL", category: "REF", reference: "P315 BFN", designation: "REF TCL Combiné 318L No Frost Inox", priceHT: 1950.000, characteristics: "Combiné, Capacité nette: 318L, Réfrigérateur: 219L, Congélateur: 99L, Classe A+, Total No Frost, Affichage LED externe, Twist Ice Maker, Inox, 595x1850x630mm" },
  { brand: "TCL", category: "REF", reference: "C512 CDN", designation: "REF TCL Quatre Portes 512L No Frost Inverter Inox", priceHT: 4900.000, characteristics: "Quatre Portes, Capacité nette: 512L, Réfrigérateur: 348L, Congélateur: 148L, Zone flexible: 16L, Total No Frost, Inverter, Multi-air flow, Affichage LED, Sky Power LED, Twist Ice Maker, Inox, 909x690x1900mm, Garantie compresseur 10 ans" },
  { brand: "TCL", category: "REF", reference: "P370", designation: "REF TCL Double portes 286L No Frost Silver", priceHT: 1720.000, characteristics: "Double portes, Capacité nette: 286L, Réfrigérateur: 225L, Congélateur: 61L, Classe A+, Total No Frost, Contrôle électronique, Affichage LED, Silver, 545x1770x620mm" },
  { brand: "TCL", category: "REF", reference: "P417 BFN", designation: "REF TCL Combiné 417L No Frost Inverter Inox", priceHT: 2575.000, characteristics: "Combiné, Capacité nette: 417L, Réfrigérateur: 276L, Congélateur: 141L, Classe A+, Total No Frost, Inverter, Affichage LED, Grand bac à fruits et légumes, Twist Ice Maker, Inox" },
];

// Image mapping per category
const imgMap = {
  "MAL": "img/mal.png",
  "LAVE VAISSELLE": "img/lave-vaisselle.png",
  "REF": "img/ref.png",
  "CONG": "img/congelateur.png",
  "CLIM": "img/clim.png",
  "ENCASTRABLE": "img/encastrable.png",
  "PEM": "img/pem.png",
  "TV": "img/tv.png",
  "MICRO ONDE": "img/micro-onde.png"
};
...
const processed = rawProducts.map((p, index) => {
  const result = {
    ...
    brand: p.brand,
    category: p.category,
    categoryLabel: categoryNames[p.category] || p.category,
    reference: p.reference,
    price: p.priceHT,
    img: imgMap[p.category] || "img/default.png",
    isNew: false,
    desc: p.characteristics || (p.brand + " - Réf: " + p.reference),
    specs: {
      "Marque": p.brand,
      "Référence": p.reference,
      "Catégorie": categoryNames[p.category] || p.category,
      "Prix HT": p.priceHT.toFixed(2) + " DA"
    }
  };
  return result;
});
...
// Output as JSON
fs.writeFileSync('/home/nassim/.gemini/antigravity/scratch/d-tech/products_data.json', JSON.stringify(processed, null, 2));
console.log("Generated " + processed.length + " products.");
console.log("Categories: " + [...new Set(rawProducts.map(p => p.category))].join(", "));
console.log("Brands: " + [...new Set(rawProducts.map(p => p.brand))].join(", "));
